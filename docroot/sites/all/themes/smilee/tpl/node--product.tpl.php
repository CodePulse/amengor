    ...
    <div class="product-item">
      ...
      <div class="item-thumb">
        ...
        <?php print theme('image_style', array(
          'path' => $imageoneuri,
          'style_name' => 'image500x650',
          'attributes' => array('alt' => $title, 'class' => 'img-responsive')
        )); ?>
          ...
          <div class="ps-img ps-img<?php print $key + 1; ?>">
            ...
            <span>
                            ...
                            <a href="<?php print $image_url ?>"
                               onclick="window.open('<?php print $image_url ?>', 'newwindow', 'width=600, height=650');

                                 return false;"><i class="fa fa-arrows-alt"></i>
                              View Full Screen</a>
      ...
      <div class="ps-slider-nav">
        ...
        <ul>
          ...
          foreach ($image_one_uri as $key => $value) {
            ...
            <li
              id="ps-img<?php print $key + 1; ?>">  <?php print theme('image_style', array(
                'path' => $image_uri,
                'style_name' => 'image500x650',
                'attributes' => array(
                  'alt' => $title,
    ...
    <div role="tabpanel">
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active"><a href="#home"
                                                  aria-controls="home"
                                                  role="tab"
                                                  data-toggle="tab"><?php print t('Product Description'); ?></a>
        </li>

        <li role="presentation"><a href="#profile" aria-controls="profile"
                                   role="tab"
                                   data-toggle="tab"><?php print t('Customer Review'); ?></a>
        </li>
